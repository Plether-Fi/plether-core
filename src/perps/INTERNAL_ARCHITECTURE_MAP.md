...
| Liquidation bounty | Reachable liquidated-account margin -> keeper clearinghouse account | `CfdEngine` | Pays the keeper from account-backed margin without touching pool cash |

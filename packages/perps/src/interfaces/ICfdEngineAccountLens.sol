...
interface ICfdEngineAccountLens {
    ...
    /// @notice Returns detailed clearinghouse buckets, liquidation reachability, and terminal price-cap state.
    /// @dev Detailed account lens kept for internal tooling and tests.
    ///      Product-facing consumers should prefer `IPerpsTraderViews` via `PerpsPublicLens`.
    /// @param account Account to inspect
    /// @return viewData Custody, legacy close reachability, liquidation reachability, terminal price cap, and claims

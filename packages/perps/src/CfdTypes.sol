...
library CfdTypes {
    ...
    /// @param maxSkewRatio Maximum directional skew divided by pool depth for opens that do not strictly reduce
    ///        absolute skew (18-decimal WAD).
    ...
    struct RiskParams {
        ...
        uint256 maxSkewRatio; // [18 dec WAD] Non-reducing open cliff e.g., 40% (0.40e18)

...
library CfdTypes {
    ...
    /// @param targetPrice Direction-aware execution limit (8 decimals); production V3 commits require it nonzero.
    ...
    struct RiskParams {
        ...
        uint256 protocolShareBps; // e.g., 0 (protocol fee disabled by default)
    }

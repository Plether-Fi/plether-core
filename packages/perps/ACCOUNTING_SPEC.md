...
- post-trade skew above the configured cap is allowed only when the open strictly reduces absolute skew; unchanged
  or worsening above-cap skew remains invalid,

...
contract OrderRouterTest is BasePerpTest {
    ...
    function test_ExecuteOrder_SkipsFailedHeadEvenWhenExpirationDisabled() public {
        ...
        assertEq(
            router.nextExecuteId(), 2, "Executing the original head should expose the failed order as the new head"
        );
        ...
        assertEq(
            router.nextExecuteId(),
            4,
            "Single-order execution should fast-forward across failed heads even when expiration is disabled"
        );
    }

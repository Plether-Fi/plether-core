...
contract OrderRouterBlockedExecutionTest is BasePerpTest {
    ...
    function obsolete_test_FadWindow_OpenOrderStaysPendingAtExecution() public {
        ...
        assertEq(
            ...
            reservedBounty,
            "Blocked close-only execution should preserve bounty reservation"
        );
    ...
    function obsolete_test_FadWindow_BatchOpenOrderStaysPendingAtBlockedHead() public {
        ...
        assertEq(
            _executionBountyReserve(orderId),
            reservedBounty,
            "Blocked batch execution should preserve bounty reservation"
        );
...
contract OrderRouterLiquidationReservationTest is BasePerpTest {
    ...
    function test_ExecuteLiquidation_ForfeitedReservationFeedsTreasuryMarginWithoutChangingVaultDepth() public {
        address account = trader;
        _fundTrader(trader, 900e6);
    ...
    function test_ExecuteLiquidation_ForfeitsReservedCloseBountiesBeforeClearingOrders() public {
        ...
        assertGe(
            ...
            "Forfeited close-order bounty reservation should contribute to canonical vault assets"
        );
    }
...
contract KeeperFeeRefundTest is Test {
    ...
    function test_FIFOCleanupImpossibleHeadOrderHasEconomicCleanupIncentive() public {
        ...
        assertEq(
            ...
            0,
            "Cleanup should clear the reserved head-order bounty"
        );
        assertTrue(

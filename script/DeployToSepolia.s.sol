...
contract DeployToSepolia is DeployToTest {
        ...
        returns (address[] memory feeds, uint256[] memory quantities, uint256[] memory basePrices)
    {
        ...
        feeds[3] = address(new PythAdapter(PYTH_SEPOLIA, PYTH_CAD_USD, 72 hours, "CAD / USD", true, 500));
        feeds[4] = address(new PythAdapter(PYTH_SEPOLIA, PYTH_SEK_USD, 72 hours, "SEK / USD", true, 500));
        feeds[5] = address(new PythAdapter(PYTH_SEPOLIA, PYTH_CHF_USD, 72 hours, "CHF / USD", true, 500));
